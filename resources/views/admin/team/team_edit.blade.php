                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('update.team') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="team_name" class="form-control" type="text" value="{{ $teams->team_name }}" id="example-text-input">
                                @error('team_name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="team_position" class="form-control" type="text" value="{{ $teams->team_position }}" id="example-text-input">
                                @error('team_position')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="elm1" name="team_desc">{{ $teams->team_desc }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="team_fb" class="form-control" type="text" value="{{ $teams->team_fb }}" id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="team_twitter" class="form-control" type="text" value="{{ $teams->team_twitter }}" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="team_linkedin" class="form-control" type="text" value="{{ $teams->team_linkedin }}" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                            <div class="col-sm-10">
                            <img id="showImage" class="rounded avatar-lg" src="{{ asset( $teams->team_image ) }}" alt="Card image cap">
                            </div>
                        </div>
