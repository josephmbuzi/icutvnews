        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add Service Page Section</h4> <br><br>
                    ...
                    <form method="post" action="{{ route('store.service') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="service_name" class="form-control" type="text" value="" id="example-text-input">
                                @error('service_name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="service_title" class="form-control" type="text" value="" id="example-text-input">
                                @error('service_title')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="service_short_desc" class="form-control" type="text" value="" id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="service_list" class="form-control" type="text" placeholder="Separate with commas" data-role="tagsinput">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="meta_keyword" class="form-control" type="text" placeholder="Separate with commas" data-role="tagsinput">
