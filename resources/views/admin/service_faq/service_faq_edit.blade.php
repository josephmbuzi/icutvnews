        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" id="myForm" action="{{ route('update.faq') }}" >
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-10">
                                <input name="faq" class="form-control" type="text" value="$service_faq->faq" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-10">
                                <input name="faq_answer" class="form-control" type="text" value="$service_faq->faq_answer" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
