        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add Testimonial Data</h4> <br><br>
                    ...
                    <form method="post" action="{{ route('store.testimonial') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="client_name" class="form-control" type="text" value="" id="example-text-input">
                                @error('client_name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="client_position" class="form-control" type="text" value="" id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="testimonial" class="form-control" type="text" value="" id="example-text-input">
                                @error('testimonial')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Testimonial Data">
                    </form>
