        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add Review Page</h4> <br><br>
                    ...
                    <form method="post" action="{{ route('store.review') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="review_category_id" class="form-select" aria-label="Default select example">
                                    ...
                                    <option value="{{ $cat->id }}">{{ $cat->review_category }}</option>
                                    @endforeach
                                    </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="review_title" class="form-control" type="text" value="" id="example-text-input">
                                @error('review_title')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="review_video_url" class="form-control" type="text" value="" id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="review_rating" class="form-control" type="number" min="1" max="5" step="1" value="{{ old('review_rating') }}">
                                @error('review_rating')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="review_tags" class="form-control" type="text" placeholder="tech,samsung" data-role="tagsinput">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="elm1" name="review_description"></textarea>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <!-- end row -->
                        <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Review Data">
                    </form>
