        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Advert</h4> <br><br>
                    ...
                    <form method="post" action="{{ route('store.advert') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="advert_link" class="form-control" type="text" value="" id="example-text-input">
                                @error('advert_link')
                        ...
                        <!-- end row -->
                        <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Advert Data">
                    </form>
