        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">About Page Section</h4>
                    ...
                    <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Why Us Title</label>
                            <div class="col-sm-10">
                                <input name="whyus_title" class="form-control" type="text" value="{{ $aboutpage->whyus_title }}" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->

                        <div class="row mb-3">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Why Us Short Description</label>
                            <div class="col-sm-10">
                            <textarea name="whyus_short_description" required="" class="form-control" rows="5">
